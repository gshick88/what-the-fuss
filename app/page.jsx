  ...
  return (
    <>
      ...
      <main className="flex-1 flex flex-col w-full mx-auto px-4 pt-6 pb-4 max-w-md md:max-w-lg">
        <div className="mb-5">
          <h1 className="font-display text-[36px] md:text-[42px] font-medium text-wtf-text leading-[1.05]">
            What's the <em className="italic">fuss</em>?
          </h1>
          <p className="text-[16px] md:text-[17px] text-wtf-text-3 mt-2 leading-relaxed">
        ...
        {!baby && (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="text-[16px] font-medium text-wtf-berry-dark">Set up the baby profile.</div>
              <div className="text-[13px] text-wtf-berry-dark/75 mt-0.5">30 seconds. Makes every answer 10× better.</div>
            </div>
        ...
        <div className="mt-auto pt-6">
          ...
          />
          <div className="text-[13px] text-wtf-muted text-center mt-2.5 leading-relaxed">
