  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        <div className="fs-chip font-medium text-wtf-text leading-tight">{topic.label}</div>
        <div className="fs-chip-sub text-wtf-muted leading-tight mt-0.5 truncate">{topic.sub}</div>
      </div>
    </button>
  );
}
